...
public class ChargeEnemy : AbstractEnemy {
    ...
    private bool PlayerInHitRange { get { return Utils.GetRelativeDistance(transform.position, CameraHelper.Stats.camPos) < hitRange; } }
       ...
       // Debug.Log ("Attack State : ");
            ...
            && (isCharging == false))
        {
           // Debug.Log ("Launching attack");
            ...
            isCharging = true;
            playerGotHit = false;
            Vector3 playerRelativePos = GetRelativePosition(CameraHelper.Stats.camPos);
